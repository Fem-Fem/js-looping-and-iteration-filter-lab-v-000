...
function fuzzyMatch(drivers, string) {
  ...
  // x = drivers.filter(function (driver_name) { if (driver_name[0, string.length] == string) {return driver_name}; });
  x = drivers.filter(function (driver_name) { if (2 == 2) {return driver_name; });
